...
def parse_pcap(pcap_file: Path,output_path: Path):
    ...
    for pkt in pkts:
        ...
        data.append([time, src_ip, src_port, dst_ip, dst_port, layer4_protocol, layer2_protocol,l7_proto])


    # Create the column names
    column_names = ['timestamp', 'source_ip', 'source_port', 'destination_ip', 'destination_port', 'l4_proto', 'l2_proto','l7_proto']
